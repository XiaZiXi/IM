...
typedef CMD_2T ADD_FRI_CMD_2T_CTOC;//添加好友
...
typedef CMD_2T LOGIN_TELL_FRIEND_CMD_2T_STOC;//登入告知好友们们
...
const ADD_FRI_CMD_2T_CTOC ADD_FRI_CMD_2V_CTOC = (ADD_FRI_CMD_2T_CTOC)16;
//服务端命令(server to client)
...
typedef struct _ADD_FRI//"添加好友"消息
{
    DataHead_18T head;
    QString body;
}ADD_FRI_CTOC;
...
/////////////////////////////////****************************************
static ADD_FRI_CTOC getADD_FRI_CTOC(USERID_2T id,QString content)//“发送消息”消息
{
    ADD_FRI_CTOC ret;

    ret.head.setcmd(ADD_FRI_CMD_2V_CTOC);
    ret.head.setid(id);
    ret.body = content;
