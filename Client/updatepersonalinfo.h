#ifndef UPDATEPERSONALINFO_H
#define UPDATEPERSONALINFO_H
...
class UpdatePersonalInfo : public QWidget
{
    Q_OBJECT

public:
    UpdatePersonalInfo(USERID_2T myid,RegistRequest selfinfo,QWidget *parent,QString serverIP,USERID_2T serverPORT,QString myip);
...
public :
    ...
    RegistRequest getSelfInfo();
};

#endif // UPDATEPERSONALINFO_H
